...
class UserTest(unittest.TestCase):
    ...
    def test_user_exists9(self):
        ...
        self.assertEqual(a['meetingName'],'Chez Panisse')
        self.assertEqual(a['meetingLocation'],{'latitude': 37.8795938, 'longitude': -122.2689348})
...
class TestLocation(unittest.TestCase):
    ...
    def test_get_meeting_location(self):
        ...
        self.assertEqual(a['latitude'], 40.3849469)
        self.assertEqual(a['longitude'], -122.2815379)
        self.assertEqual(a['name'], 'Main Street Diner')
        self.assertEqual(a['address'], '3342 Main St Cottonwood, CA 96022')
